...
import 'package:fweather/src/constants/constants.dart';
...
import 'package:fweather/src/services/getlocator.dart';
import 'package:fweather/src/utils/logging.dart';
  ...
  static Future<Map<String, dynamic>> _fetchData(String url) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        printWarning('Veri yüklenemedi: ${response.statusCode}');
        throw Exception('Veri yüklenemedi');
      }
    } catch (e) {
      printWarning('Veri alınırken hata oluştu $url: $e');
      throw Exception(
          'Veri alınırken hata oluştu. İnternet Bağlantınızı Kontrol Edin');
    }
  }
}
